        ...
        <InnerBox>
          ...
          <div>
            ...
            <div className="flex flex-col gap-5">
              <div>
                <h2 className=" font-medium text-[15px] md:text-[20px]">ชื่อไอเดีย</h2>
                <input
                  type="text"
              ...
              <div>
                <h2 className=" font-medium text-[15px] md:text-[20px]">แนบไฟล์ PDF</h2>
                <div className={`${styles.file_upload} text-[16px] border-[#000] border-opacity-20 border bg-transparent bg-opacity-0 rounded-[4px] w-full p-4`}>
                  <h3 className=" text-[16px] absolute cursor-pointer">{selectedName || "เพิ่มไฟล์"}</h3>
