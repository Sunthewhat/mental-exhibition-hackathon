...
const UniTeam: React.FC = () => {
  ...
  const clickHandle = () => {
    router.push('/hackathon_form/pages/uniteam_data_page?num=1')
  }
      ...
      <OuterBox>
        <InnerBox>
          <div className="flex flex-col items-center">
            <h1 className="text-[#5A81BC] text-[24px] font-bold">ระดับอุดมศึกษา</h1>
          </div>
          <div>
            <ul className="list-style-none mb-5">
              <li>- มีสมาชิกในทีม 3-5 คน</li>
              <li>- สมาชิกอย่างน้อย 3 คนต้องศึกษาอยู่ในมหาวิทยาลัยเทคโนโลยีพระจอมเกล้าธนบุรี </li>
