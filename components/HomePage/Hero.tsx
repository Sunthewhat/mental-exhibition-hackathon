...
export default function Hero() {
  ...
  const style = window.innerWidth >= 768 ? `${res_buttonStyle.base} ${res_buttonStyle.tablet}` : `${res_buttonStyle.mobile} ${res_buttonStyle.base}`;
    ...
    <div className="relative flex flex-col gap-12 w-full h-[470px] md:h-[730px] items-center justify-center">
      ...
      <div className="relative flex items-center justify-center">
        ...
        <Link href='/' className={style}>
          <Image src='/shiny-effect.svg' alt="shiny" width={92} height={130} className="absolute z-50 -top-14 -left-10"/>
          Play Game
        </Link>
      </div>
      ...
      <div className="absolute -left-10 top-60 md:left-32 md:top-[500px]">
        <ShineBox blurAmount="blur-xl" boxSize={100}>
          <Image src='/butterfly-blue.svg' alt="butterfly" width={85} height={120}/>
        </ShineBox>
      </div>
      
      <div className="absolute -right-32 top-32 md:right-10 md:top-[300px]">
        <ShineBox blurAmount="blur-xl" boxSize={160}>
          <Image src='/butterfly-purple.svg' alt="butterfly" width={180} height={240}/>
        </ShineBox>
      </div>
